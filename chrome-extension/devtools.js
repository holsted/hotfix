...
chrome.devtools.panels.create("Hotfix", "img/toolbar.png", "/panel.html", function(extensionPanel) {
    ...
    // Declare an array to hold the resources that are edited. We have to do it here
    // instead of panel.js because otherwise the user would have to first click on the hotfix panel in order
    // for us to store the resources they edit. That's why we have to use two arrays and make sure they
    // are always in sync
	...
	// When a resource is edited, this grabs the url and content of the resource and adds it to devResources.
